...
### 1. qPCR Diagnostic Suite (`pcr.py`)
...
If you utilize the kinetic calculation engine or other components of this toolkit to audit molecular data for peer-reviewed research, please cite the framework as follows:

Frank, M. G. (2026). qPCR Diagnostic Suite: Global Kinetics & Local Precision Analytics for Relative Expression Optimization. Open-source software framework for kinetic parameter evaluation. Digital Object Identifier: [Insert Your Zenodo DOI Link Here]
